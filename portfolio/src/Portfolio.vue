...
const artworks: Artwork[] = [
  ...
  },
  {
    ...
    medium: "Oil Paint",
    description: "I realized that because the cat’s fur was white, the environment could influence its colors even more so than if it was not. I made sure her eyes were the most striking part of the piece by having its highlights be the only pure white found in the piece.",
