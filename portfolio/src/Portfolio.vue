...
const artworks: Artwork[] = [
  {
    ...
    medium: 'Graphite',
    description:
      'When my sister was in the ICU, I drew her while she was spacing out after a few days in the hospital, a moment of calm after a traumatic event. She had the water pressed to her lips, yet was not drinking. Her hair had not been washed for days, and still had pieces of medical tape buried within, which is why there are stray strands everywhere. I had to exaggerate the dim hospital lighting on her face so that she would stand out.',
  ...
  },
  {
    ...
    description:
      'A portrait of my brother with autism. It felt right to use mixed media to echo the unique, layered way he thinks. Instead of facial features, his thoughts and interests: trains, traffic lights, and blocks, scramble out into his hands.',
  ...
  },
  {
    ...
    medium: 'Acrylic',
    description:
      'This painting uses a shape-sorting cube as a literal representation of the metaphor of “fitting in”. The 2-D figure stands in contrast to the 3-D world, exacerbating its displacement. The figure casts a long, lonely shadow and its static shows both uncertainty and a multifaceted identity.',
    images: [
  ...
  },
  {
    ...
    description:
      'Drawn from a photo of my girlfriend, sister, and cat napping together on my bed. The unorganized placements of the subjects bring a breath of intimacy to the composition. I sketched in ink, keeping in mind the negative space.',
  ...
  },
  {
    ...
    medium: 'Prismacolor',
    description:
      'On the right, I stand in America snacking on lotus root whilst looking back at my memories from when I lived in China and harvested them with my dad and community. To differentiate between background, midground and foreground, I used progressively less saturated color schemes in the back.',
  ...
  },
  {
    ...
    medium: 'Oil Paint',
    description:
      'Exploring giving new life to art waste, I emptied my pencil sharpeners, scraped my old, dried palettes, and used glue to make the shape and texture of the tree. At the very end, I used a pallet knife to replicate the dried, crusty parts that tree bark has.',
  ...
  },
  {
    ...
    description:
      'A commentary on the horrors of animal experimentation through the style reminiscent of a PSA poster. The piece confronts viewers through the gaze of a human-like eye. It becomes harder to ignore animal suffering when human attributes are assigned to them. The eye is the only realistic aspect, and is dead center looking directly at the viewer, amplifying discomfort and guilt.',
  ...
  },
  {
    ...
    medium: 'Oil Paint',
    description:
      'I realized that because the cat’s fur was white, the environment could influence its colors even more so than if it was not. I made sure her eyes were the most striking part of the piece by having its highlights be the only pure white found in the piece.',
  ...
  },
  {
    ...
    description:
      'A small archive of my creative process with whatever I have on hand when an idea pops up. Quick sketches, composition trials, and experimentation.',
  ...
  <section id="projects" class="bg-orange-50 px-6 py-16 text-[#221e22] lg:px-8">
    <div class="mx-auto max-w-6xl">
      <div class="mx-auto max-w-3xl text-center">
        <p class="text-sm font-semibold tracking-[0.35em] text-orange-600 uppercase">Gallery</p>
        <h1 class="mt-3 text-4xl font-black tracking-tight sm:text-5xl">Art Projects</h1>
        <p class="mt-4 text-lg leading-8 text-stone-700">Selected portfolio artwork</p>
      </div>
      ...
      <div class="mt-14 space-y-16">
        ...
        >
          <div class="lg:pt-8">
            <p class="text-sm font-bold tracking-[0.3em] text-orange-600 uppercase">Portfolio</p>
            <h2 class="mt-3 text-3xl font-black tracking-tight">{{ artwork.title }}</h2>
            <p
              v-if="artwork.dimensions || artwork.medium"
              class="mt-3 text-sm font-semibold tracking-widest text-stone-500 uppercase"
            >
