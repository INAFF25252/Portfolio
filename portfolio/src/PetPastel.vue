...
const mediaItems: MediaItem[] = [
  {
    title: '2025 Gallery',
    description: 'Second annual charity gallery where we raised $2,300 for the ACC of NYC.',
    type: 'image',
  ...
  <section class="bg-orange-50 px-6 py-16 text-[#221e22] lg:px-8">
    <div class="mx-auto max-w-6xl">
      <div class="mx-auto max-w-3xl text-center">
        ...
        <div class="mt-4 flex flex-col items-center gap-2">
          <a
            ...
            class="text-sm font-bold tracking-widest text-orange-600 uppercase transition hover:text-orange-800"
          >
            @pet_pastel_
          </a>
          <a
      ...
      <div class="mt-14 space-y-16">
        ...
        >
          <div class="lg:pt-8">
            <p class="text-sm font-bold tracking-[0.3em] text-orange-600 uppercase">Pet Pastel</p>
